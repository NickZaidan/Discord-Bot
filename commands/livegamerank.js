        ...
        for(let i = 0; i < match.participants.length; i++){
            ...
            switch(!isEmptyObject(userRankResponse)){
                case true:
                    for(let x = 0; x < userRankResponse.length; x++){
                        ...
                        switch(userRankResponse[x].queueType){
                            case "RANKED_SOLO_5x5":
                                ...
                                reply = reply + userRankResponse[x].tier[0]  + userRankResponse[x].tier.substring(1).toLowerCase() + " " + userRankResponse[x].rank + " " + userRankResponse[x].leaguePoints + " LP\nWins: " + userRankResponse[x].wins + " | Losses: " + userRankResponse[x].losses + "\n\n";
                                break;
                    ...
                    //reply = reply + summoner + ": " + userRankResponse[0].tier[0] + userRankResponse[0].tier.substring(1).toLowerCase() + " " + userRankResponse[0].rank + " " + userRankResponse[0].leaguePoints + " LP\n";
                    break;
                case false:
                    reply = reply + summoner + ": " + "Unranked\n\n";
                    break;
